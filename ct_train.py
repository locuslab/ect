...
@click.option('--amp',           help='Enable torch.cuda.amp.GradScaler for mixed precision training, \
...
def main(**kwargs):
    ...
    c.update(loss_scaling=opts.ls, cudnn_benchmark=opts.bench, enable_tf32=opts.tf32, enable_gradscaler=opts.enable_amp)
